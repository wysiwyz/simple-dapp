...
// Describes metadata related to a provider based on EIP-6963 (Wallet metadata announcement)
...
// Represents the structure of a provider based on EIP-1193 (Ethereum Provider JavaScript API)
